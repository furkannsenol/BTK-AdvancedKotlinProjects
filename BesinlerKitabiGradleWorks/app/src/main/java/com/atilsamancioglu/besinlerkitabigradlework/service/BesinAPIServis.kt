...
class BesinAPIServis {
    ...
    private val api = Retrofit.Builder()
        .baseUrl(BASE_URL)
        .addConverterFactory(GsonConverterFactory.create())//json formatına döndürür
        .addCallAdapterFactory(RxJava2CallAdapterFactory.create())//rx ile çalışacağı için bunu ekliyoruz
        .build()
